...
/**
 * This class calculates and creates pie chart
 * 
...
public class PieApp {
	...
	public PieApp(PriorityQueueBH<Activity> pqHeap) {
		int numPriorities = 5;
		...
		priority1.setText("Priority 1 " + labels[0]);
		priority2.setText("Priority 2 " + labels[1]);
		priority3.setText("Priority 3 " + labels[2]);
		priority4.setText("Priority 4 " + labels[3]);
		priority5.setText("Priority 5 " + labels[4]);
		...
		PieChart pieChart = new PieChart(times, colors, "Priority Pie Chart");
