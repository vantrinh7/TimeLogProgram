...
/**
 * This class calculates and creates horizontal stacked bar chart
 * 
...
public class BarApp {
	 ...
	 * @param args
	 */
	public BarApp(PriorityQueueBH<Activity> pqHeap) {
		...
		// Colors for if 1 is of the highest priority
		...
		BarPanel barPanel = new BarPanel(times, colors, "Priority Stacked Bar Chart");
